...
The django-polls_ project is a basic poll application and is part of the collection of `Web Framework Projects`_ . This repository runs a Django 5.1.x application demonstrating some of the basic Django functionality.

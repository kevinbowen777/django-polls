...
For clarity's sake, the following variables in the `.env` file need to be set manually:
 ...
 .. code-block:: console
    ...
    # DATABASE_URL=sqlite:///django-polls.sqlite3
    # export POSTGRES_DB=django-polls.sqlite3
    DATABASE_URL=postgres://django_admin:<secret_key>@localhost:5432/django-polls
    export POSTGRES_USER=django_admin
    export POSTGRES_PASSWORD=<postgres_password>
    export POSTGRES_DB=django-polls
...
By default, the `.env` file is set up to run the `django-polls` project locally
